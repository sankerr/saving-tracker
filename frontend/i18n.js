...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'dashboard.caption': 'Default view shows the current month forward through your chosen horizon. Drag horizontally on the chart, or pick start/end months above to focus on a sub-range.',
    ...
    he: {
      ...
      'disclaimer.item.noTax': '<strong>אין חישוב מס.</strong> המספרים לפני מס ובערכים נומינליים. כללי המס בישראל אינם ממודלים — התייעצו עם מנהל הקופה, רואה חשבון או רשות המסים.',
      ...
      'pension.excludedFromTotal': 'לא נכלל בסך הלוח',
      ...
      'dashboard.caption': 'ברירת המחדל מציגה מהחודש הנוכחי קדימה לפי האופק שבחרתם. גררו אופקית בגרף או בחרו חודשי התחלה/סיום למיקוד.',

      'chat.title': 'צ׳אט תיק',
      'chat.panelAria': 'צ׳אט AI לתיק',
      'chat.clear': 'ניקוי',
      ...
      'chat.role.you': 'אתם',
      'chat.role.assistant': 'עוזר',
      'chat.thinking': 'חושב…',
      'chat.disabled': 'הצ׳אט כבוי בשרת.',
      'chat.sorry': 'מצטערים — לא הצלחתי לענות ({error}).',
